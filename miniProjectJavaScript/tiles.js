...
function preload() {
    ...
    preloadText = new createjs.Text("Hello", "50px Courier New", "#FFF");
    ...
    queue.loadManifest([
        ...
        {id: "introVideo", src: "img/intro.mp4"}
...
function removeIntroVideo() {
    var removeIntroVideo = document.getElementById('introVideo');
    removeIntroVideo.parentNode.removeChild(removeIntroVideo);
    var addCanvas = document.getElementById('canvas').style.display = 'block';
    bgMusic.volume = 1;
    return false;
}
function removeFirstDialog() {
    var removeFirstDialog = document.getElementById('firstDialog').style.display = 'none';
    pauseVid();
    var addCanvas = document.getElementById('canvas').style.display = 'block';
    bgMusic.volume = 1;
    return false;
}
function removeSecondDialog() {
    var removeSecondDialog = document.getElementById('secondDialog').style.display = 'none';
    pauseVid();
    var addCanvas = document.getElementById('canvas').style.display = 'block';
    bgMusic.volume = 1;
    return false;
    ...
    switch(grid[row][col].tileNumber){
        ...
        case 15, 16, 17, 33, 34, 35, 51, 52, 53, 54,55,56,72,73,74,90,91,92,62,63,64,80,81,82:
         ...
         case 57:
            ...
            break;
        case 60:
            var removeCanvas = document.getElementById('canvas').style.display='none';
            playSecondVid();
            grid[row][col].gotoAndStop("grass");
            grid[row][col].tileNumber=240;
            return true;
